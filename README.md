...
Django server will be available on port 8000.

    curl http://localhost:8000/todo/api/v1/tasks
...
Example: http://localhost:8000/todo/api/v1/tasks
...
Example: http://localhost:8000/todo/api/v1/tasks/[id]
...
Example: Create – POST  http://localhost:8000/todo/api/v1/tasks
...
Example: Update - PUT  http://localhost:8000/todo/api/v1/tasks/[id]
...
Example: Delete - DELETE http://localhost:8000/todo/api/v1/tasks/[id]
...
Here are some curl examples to execute by yourself:
    ...
    curl -X POST -H 'Content-type: application/json' \
      ...
      http://localhost:8000/todo/api/v1/tasks
    ...
    curl -X PUT \
      ...
      http://localhost:8000/todo/api/v1/tasks/3

    curl http://localhost:8000/todo/api/v1/tasks/1

    curl -X DELETE http://localhost:8000/todo/api/v1/tasks/1
